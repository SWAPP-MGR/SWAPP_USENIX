...
| [JSONP Guard](https://github.com/cpx0rpc/swapp/tree/main/apps#jsonp)          | Implementing | An application to validate JSONP return value to prevent JSONP XSS Attacks. |
